...
class Pure_Pursuit:
    ...
    def main_drive(self, goal):
        ...
        if d > 20:
            if  (f*np.sqrt(2) - 0.05 <= e) and (e <= f*np.sqrt(2) + 0.05) and (f*np.sqrt(2) - 0.05 <= g) and (g <= f*np.sqrt(2) + 0.05) and (M < 680):
                print("Buster")
                self.speed_gain = self.speed_gain - 5
            elif (b*np.sqrt(2) - 0.05 <= c) and (c <= b*np.sqrt(2) + 0.05) and (b*np.sqrt(2) - 0.05 <= a) and (a <= b*np.sqrt(2) + 0.05) and (M < 680):
                print("Buster")
                self.speed_gain = self.speed_gain - 5
            else:
                pass
